...
public class Controller implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		ser1.setData( FXCollections.observableArrayList(
				new XYChart.Data("2021",50), new XYChart.Data("2022",20),
				new XYChart.Data("2023",10), new XYChart.Data("2024",60)
				) );
		...
		ser2.setData( FXCollections.observableArrayList(
				new XYChart.Data("2021",60), new XYChart.Data("2022",30),
				new XYChart.Data("2023",20), new XYChart.Data("2024",40)
				) );
		//li1.add(ser2);
	...
	public void testFunc() {
		...
		list.add(d1);
		Data d2 = new PieChart.Data("1111", 20);
		list.add(d2);
